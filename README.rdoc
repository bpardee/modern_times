...
Create config/jms.yml which might look as follows:
    ...
    staging:
      ...
      :username: system
      :password: <%=Encryption.try_decrypt "FtYfNPIKt23Gny0MIr3osg==\n" %>
    ...
    production:
      ...
      :username: system
      :password: <%=Encryption.try_decrypt "Qz4SdRh4KfY1k/IpmSIcJQ==\n" %>
...
this by explicitily by specifying a queue or a virtual topic instead.  A virtual_topic allows you to publish to one destination
